    ...
    <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <div className="bg-white/80 backdrop-blur-md shadow-sm border border-slate-100 rounded-full px-6 h-20 flex items-center justify-between w-full max-w-5xl">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="https://wa.me/6285353041213"
            className="bg-teal-700 hover:bg-teal-800 text-white px-5 py-2 rounded-full text-sm font-medium transition-all flex items-center gap-2"
          >
            <Phone size={16} />
            Hubungi Kami
          </Link>
